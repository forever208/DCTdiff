...
def get_config():
    ...
    config.dataset = d(
        name='ffhq256',
        path='/home/mning2/datasets/ffhq256_jpg',  # /data/clusterfs/mld/users/lanliu/mang/datasets/ffhq256  /home/mang/Downloads/ffhq256_jpg
        fid_stat='assets/fid_stats/fid_stats_ffhq256_jpg.npz',
        resolution=256,
        tokens=256,  # number of tokens to the network
        low_freqs=28,  # could be 10, 13, 15, 16 (<=16)
