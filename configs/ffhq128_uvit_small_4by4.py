...
def get_config():
    ...
    config.dataset = d(
        name='ffhq128',
        path='/data/scratch/datasets/ffhq128',
        resolution=128,
        tokens=256,  # number of tokens to the network
        low_freqs=9,  # B*B - m
        block_sz=4,  # B
        ...
        Y_bound=[480.25],  # eta
        Y_std=[6.53, 3.478, 2.196, 1.405, 3.378, 2.381, 1.765, 1.185, 2.072, 1.697, 1.291, 0.999, 1.291, 1.083, 0.999, 0.999],  # Entropy-Based Frequency Reweighting (EBFR)
