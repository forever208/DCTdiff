...
def get_config():
    ...
    config.dataset = d(
        name='ffhq256',
        path='/data/scratch/datasets/ffhq256',
        resolution=256,
        tokens=1024,  # number of tokens to the network
        low_freqs=8,  # B*B - m*
        block_sz=4,  # B
        ...
        Y_bound=[485.0],  # eta
        Y_std=[6.543, 2.894, 1.769, 1.197, 2.8, 1.916, 1.458, 1.029, 1.647, 1.386, 1.106, 0.994, 1.107, 0.996, 0.994, 0.996],  # Entropy-Based Frequency Reweighting (EBFR)
