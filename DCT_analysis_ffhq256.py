...
# # before reorder
# Y_mean = np.full((64,), 0.0)
#
# Cb_mean = np.full((64,), 0.0)
#
# Cr_mean = np.full((64,), 0.0)
#
#
# # bound of 97% interval
# Y_bound = np.full((64,), 977.0)
#
# Cb_bound = np.full((64,), 977.0)
#
# Cr_bound = np.full((64,), 977.0)
#
#
# Y_std = np.array(
#     [6.521, 3.499, 2.347, 1.693, 1.388, 1.422, 1.176, 0.999, 3.395, 2.384, 1.938, 1.635, 1.272, 1.246, 1.073, 0.997, 2.226, 1.873, 1.55, 1.364, 1.472, 1.181, 0.998, 0.998, 1.646, 1.342, 1.375, 1.113, 1.273, 0.997, 0.998, 0.997, 1.22, 1.287, 1.023, 1.212, 1.032, 0.998, 0.998, 0.998, 1.138, 0.997, 1.147, 1.02, 0.998, 0.997, 0.998, 0.997, 1.134, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.999, 0.997, 0.999, 0.997, 0.998, 0.997, 0.998, 0.997]
# )
#
# Cb_std = np.array(
#     [4.169, 1.772, 1.265, 1.072, 1.0, 0.999, 1.0, 0.989, 1.614, 1.269, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 1.215, 0.998, 0.998, 0.999, 0.998, 0.996, 0.998, 1.0, 1.018, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.999, 0.998, 0.999, 0.998, 1.0, 0.998, 0.998, 0.996, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.999, 0.998, 1.0, 0.998, 0.997, 0.998, 1.0, 0.997, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998]
# )
#
# Cr_std = np.array(
#     [4.422, 1.938, 1.335, 1.136, 1.0, 1.0, 1.0, 0.991, 1.793, 1.355, 1.061, 0.998, 0.998, 0.998, 0.998, 0.998, 1.308, 1.066, 1.053, 0.999, 0.998, 0.996, 0.998, 1.0, 1.109, 0.998, 0.999, 0.998, 0.998, 0.998, 0.998, 0.998, 0.998, 0.999, 0.998, 0.998, 0.998, 1.0, 0.998, 0.998, 1.0, 0.998, 0.998, 0.998, 0.997, 0.998, 0.998, 0.998, 0.999, 0.999, 0.998, 1.0, 0.998, 0.997, 0.998, 1.0, 0.999, 0.998, 0.997, 0.998, 0.997, 0.998, 0.998, 0.998]
# )
...
# before reorder
Y_mean = np.full((16,), 0.0)

Cb_mean = np.full((16,), 0.0)

Cr_mean = np.full((16,), 0.0)


# bound of 96.5% interval
Y_bound = np.full((16,), 485.0)

Cb_bound = np.full((16,), 485.0)

Cr_bound = np.full((16,), 485.0)


Y_std = np.array(
    [6.543, 2.894, 1.769, 1.197, 2.8, 1.916, 1.458, 1.029, 1.647, 1.386, 1.106, 0.994, 1.107, 0.996, 0.994, 0.996]
)

Cb_std = np.array(
    [4.173, 1.392, 0.992, 0.989, 1.338, 0.991, 0.99, 0.991, 0.992, 0.992, 0.989, 0.991, 0.99, 0.991, 0.991, 0.991]
)

Cr_std = np.array(
    [4.417, 1.52, 0.993, 0.99, 1.473, 0.991, 0.99, 0.991, 0.993, 0.991, 0.989, 0.99, 0.997, 0.991, 0.989, 0.991]
)
...
if __name__ == "__main__":
    ...
    # image_to_DCT_array(img_folder='/home/mang/Downloads/ffhq256_jpg/ffhq256',
    #                    block_sz=4, coe='cr')
    DCT_statis_from_array(array_path='/home/mang/Downloads/ffhq256_4by4_cr.npy',
                          block_sz=4, thresh=1.75)
